 ...
 * \date   March 2024
***********************************************************************/
#ifndef CANDIDATEOPL_H
#define CANDIDATEOPL_H
 ...
 * 
 */
class CandidateOPL : public Candidate {
private:
...
public:
    ...
    /**
     * \brief This function sets the ranking Candidate in the OPL election
     * 
    ...
    /**
     * \brief This function returns a Ballot object for a specifc Candidate in the OPL election
     * 
     * \param None This function does not take in any parameters
    ...
    /**
     * \brief This function sets the Ballot for a specific Candidate in the OPL election
     * 
